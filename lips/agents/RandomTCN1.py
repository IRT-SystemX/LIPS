...
class RandomTCN1(BaseAgent):
    ...
    """
    def __init__(self, action_space, subsid_list, p):
        super(RandomTCN1, self).__init__(action_space)
    ...
    def act(self, obs, reward, done):
        ...
        if ur < self._1_p:
            # connect all the elements to bus 1
            act = self.set_buses
        else:
            ...
            act = self.set_buses + self.bus_switch_action_space_as_list[id_] 
